...
if(PROVIDER.PSM2)
    ...
    if(NOT PSM2.LIB STREQUAL "DIRECT" AND NOT PSM2.LIB STREQUAL "PRELOAD")
        ERROR("PSM2: Unsupported PSM2 library mode: ${PSM2.LIB}")
    endif()
    add_definitions(-DPSM2_LIB_${PSM2.LIB})

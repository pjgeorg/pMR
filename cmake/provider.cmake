...
if(PROVIDER.OFI)
    ...
    if(OFI.PROGRESS.AUTO)
        set(OFI_CAPS "${OFI_CAPS} ProgressAuto")
        add_definitions(-DOFI_PROGRESS_AUTO)
    endif()
    ...
    if(OFI.REQUEST.MR.KEY)
        set(OFI_CAPS "${OFI_CAPS} RequestMRKey")
        add_definitions(-DOFI_REQUEST_MR_KEY)
    endif()
